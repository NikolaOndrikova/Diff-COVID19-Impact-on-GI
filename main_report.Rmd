...
outcome_df <- read.csv("./Data/dummy_outcomes.csv", sep="")
noro_vars <- read.csv("./Data/noro_vars.csv", sep="")
campy_vars <- read.csv("./Data/campy_vars.csv", sep="")
...
campy_specific_fit <- NbinomTsglm(outcome_ts = campy_ts[1:278],
                                 predictors = campy_vars[1:278,1:10])
